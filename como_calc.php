...
<body>
    ...
    <div style="background-image: url(fundo2.jpg); background-attachment: fixed;">
        ...
        <br>
        <br>
        <h3 style="margin-bottom: 3%; color: white; font-family: serif;">Como Calcular IPV4</h3>
        <br>
    ...
    Um endereço IP é um código binário de 32 bits (muitas vezes escrito na forma decimal) que contém partes de rede e hospedeiro. Os bits do hospedeiro definem um determinado computador. O prefixo da rede determina uma rede e seu comprimento depende da classe. Fazer sub-redes ajuda a organizar uma rede, quebrando-a em várias. Para defini-las, você deve pegar os bits da parte do hospedeiro do endereço IP. Isso também estende-se ao prefixo de rede. A máscara de sub-rede define explicitamente os bits de rede e do hospedeiro como 1 e 0, respectivamente. Neste exemplo, vamos calcular uma máscara de sub-rede para um computador com endereço IP 192.35.128.93, que pertence a uma rede com seis sub-redes.<br><br>

Endereço IP – Um endereço IPv4 é formado por 32 bits que é o mesmo que dizermos que possui quatro octetos representados na forma decimal (ex: 192.168.0.1). Uma parte desse endereço indica-nos a rede e a outra parte indica-nos qual a máquina.<br><br>

Máscara de rede – Para determinarmos que parte do endereço IP identifica a rede e que parte identifica a máquina, teremos de recorrer à máscara de rede (subnet mask ou netmask) associada.<br>
