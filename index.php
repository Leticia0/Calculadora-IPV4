        ...
        <div class="container" style="background-color: white; opacity: 0.7; width: 55%; border-radius: 0.3rem;">
            ...
            <div>
               ...
               <div class="">
                    ...
                    <input type="text" id="mask" name="mask" maxlength="2" size="2" class="form-control" placeholder="24" style="width: 12%; float:left; margin-left: 1%">

               </div>

                 <button class="btn btn-dark" style="margin-left: 1%; margin-top: 0%">Calcular</button>
